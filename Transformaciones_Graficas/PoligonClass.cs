...
namespace Transformaciones_Graficas
{
    ...
    public class PoligonLine : List<PoligonPoint>
    {
        #region Variables
        ...
        private PoligonPoint second1;
        private bool skip1 = false;

        private double radius2;
        private Point center2;
        private PoligonPoint second2;
        ...
        {
            this.Add(new PoligonPoint(new Point(x, y), id));
        }

        public void AddPoint(Point point, PointID id)
        {
            this.Add(new PoligonPoint(point, id));
        }
        ...
        {
            this.Insert(pos, new PoligonPoint(point, PointID.Control1));
            this.Insert(pos, new PoligonPoint(point, PointID.Anchor));
            this.Insert(pos, new PoligonPoint(point, PointID.Control2));
        ...
        public void Draw(PaintEventArgs e)
        {
            ...
            if (this.Count > 1)
            {
                ...
                e.Graphics.FillPolygon(new SolidBrush(Color.Red), this.gp.PathPoints.ToArray());
    ...
    {
        public PoligonPoint(Point _coord, PointID id)
        {
            this.Coord = _coord;
            this.Id = id;
            UpdateRect();
        ...
        private void UpdateRect()
        {
            ...
            if (Id == PointID.Anchor)
                Size = PoligonLine.anchorSize;
            else
                Size = PoligonLine.controlSize;
